...
const STATIC_PATHS = [
  ...
  '/guide/madamis-tenpo/',
  '/guide/zunousen-douga/',
  '/guide/shotengai-event/',
  '/guide/event-kikakusho/',
  '/guide/event-kpi/',
  ...
  '/guide/taikengata-idea/',
  '/guide/event-hiyou/',
  '/guide/madamis-rekishi/',
  '/guide/madamis-tokyo/',
  '/guide/immersive-taiken/',
  '/guide/zunousen-sakuhin/',
  '/guide/shinrisen-game/',
  '/guide/madamis-nazotoki-chigai/',
  '/guide/yougo/',
  '/works/',
  ...
  '/guide/shinrisen/',
  '/guide/saiji/',
  '/guide/madamis-seisaku/',
  '/guide/zunousen-seisaku/',
  '/guide/halloween-event/',
...
export const GET: APIRoute = async ({ site }) => {
  ...
  const STATIC_LASTMOD: Record<string, string> = {
    ...
    '/guide/immersive-theater/': '2026-09-13',
    ...
    '/guide/shotengai-event/': '2026-09-12',
    '/guide/event-kikakusho/': '2026-09-12',
    '/guide/event-kpi/': '2026-09-12',
    '/guide/magic-show-immersive-chigai/': '2026-09-09',
    '/guide/zunousen-cost/': '2026-09-12',
    '/guide/zunousen-tournament/': '2026-09-14',
    '/guide/shuyu-event-seisaku/': '2026-09-12',
    '/guide/madamis-haishin/': '2026-09-12',
    ...
    '/guide/shogyoshisetsu-event/': '2026-09-14',
    '/guide/yukyu-kukaku/': '2026-09-14',
    '/guide/eigyo-jikangai/': '2026-09-14',
    '/guide/museum-event/': '2026-08-13',
    '/guide/hotel-event/': '2026-09-12',
    '/guide/taikengata-event/': '2026-09-12',
    '/guide/taikengata-idea/': '2026-09-14',
    ...
    '/guide/madamis-nazotoki-chigai/': '2026-09-05',
    '/guide/yougo/': '2026-09-05',
    '/works/': '2026-09-08',
    '/guide/shuyu-event/': '2026-09-12',
    '/guide/shinrisen/': '2026-09-08',
    '/guide/sankagata-event/': '2026-09-05',
    '/guide/taikengata-company/': '2026-09-12',
    '/guide/zunousen/': '2026-09-08',
    '/guide/zunousen-game/': '2026-09-08',
    '/guide/shinrisen/': '2026-09-08',
    '/guide/saiji/': '2026-09-14',
    '/guide/madamis-seisaku/': '2026-09-12',
    '/guide/zunousen-seisaku/': '2026-09-12',
    '/guide/halloween-event/': '2026-09-14',
    '/guide/botsunyukan/': '2026-09-07',
    '/guide/popup-event/': '2026-09-14',
    ...
    '/guide/nazotoki-kenshu/': '2026-09-14',
    '/guide/shanai-event/': '2026-09-14',
    '/guide/immersive-seisaku/': '2026-09-08',
    '/guide/kisetsu-event/': '2026-09-04',
    '/guide/madamis-kenshu/': '2026-09-14',
    '/guide/immersive-making/': '2026-08-10',
    '/guide/immersive-vr/': '2026-08-10',
    '/guide/case-uwasabanashi/': '2026-09-08',
    '/services/immersive/': '2026-09-08',
    '/guide/immersive-event/': '2026-07-31',
    '/guide/immersive/': '2026-09-08',
    '/media/': '2026-08-07',
    '/company/': '2026-09-08',
    '/company/iida-yuki/': '2026-09-08',

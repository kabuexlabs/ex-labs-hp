...
export const GET: APIRoute = async ({ site }) => {
  ...
  const STATIC_LASTMOD: Record<string, string> = {
    ...
    '/guide/zunousen-tournament/': '2026-09-12',
    ...
    '/guide/eigyo-jikangai/': '2026-09-08',
    ...
    '/guide/immersive-theater/': '2026-09-06',

...
export const GET: APIRoute = async ({ site }) => {
  ...
  const STATIC_LASTMOD: Record<string, string> = {
    ...
    '/guide/hotel-event/': '2026-09-08',
    '/guide/taikengata-event/': '2026-09-07',
    '/guide/taikengata-idea/': '2026-09-05',
    '/guide/event-hiyou/': '2026-09-05',

...
export const guideArticles: GuideArticle[] = [
  {
    ...
    date: '2026-09-12',
    category: 'shisetsu',
    thumb: '/assets/guide/taiken-marketing.webp',
  },
  {
    href: '/guide/madamis-tenpo/',
    title: '飲食店・バー・ホテルへのマダミス導入｜貸切公演・常設・宿泊プランの進め方',
    desc: '貸切公演・常設プログラム・宿泊プラン連動の比較、向いている店舗、空間・人数・時間帯の準備、費用・期間、宿泊施設の事例を整理。',
    date: '2026-09-12',
    category: 'murder',
    thumb: '/assets/guide/madamis-tenpo.webp',
  },
  {
    href: '/guide/zunousen-douga/',
    title: '頭脳戦ゲームの動画・配信企画｜番組向けルール設計と制作依頼',
    desc: '映像で成立する3条件、1対1・脱落式・チーム戦・大会・視聴者参加の形式比較、ルール設計、収録までの流れ、HACKTALE作品の利用、費用・期間を整理。',
    date: '2026-09-12',
    category: 'zunou',
    thumb: '/assets/guide/zunousen-douga.webp',
  },
  {
    href: '/guide/shotengai-event/',
    title: '商店街・街全体を使う回遊イベントの企画｜下北沢の事例と進め方',
    desc: '商店街イベントの課題、店舗を巡る理由を作る周遊型の仕組み、下北沢の事例、参加店舗の協力内容と負担の抑え方、自治体との調整、費用・会期・効果の測り方。',
    date: '2026-09-12',
    category: 'shisetsu',
    thumb: '/assets/guide/shotengai-event.webp',
  },
  {
    href: '/guide/event-kikakusho/',
    title: '体験型イベントの企画書の作り方｜施設・上司に通る構成と書き方',
    desc: '企画書の9項目と抜けやすい点、体験の内容を時系列で書く方法、予算・スケジュールの書き方、施設・決裁者の質問、制作会社に渡す資料との違い。',
    date: '2026-09-12',
    category: 'shisetsu',
    thumb: '/assets/guide/event-kikakusho.webp',
  },
  {
    href: '/guide/event-kpi/',
    title: '体験型イベントの効果測定・KPI｜集客・回遊・売上をどう測るか',
    desc: 'KPIの5分類、目的別に主要指標を1つ決める方法、現場で取れるデータ、費用対効果の計算例（仮の数字）、公開実績の指標、レベニューシェア型の指標。',
    date: '2026-09-12',
    category: 'shisetsu',
    thumb: '/assets/guide/event-kpi.webp',
  },
  {
  ...
  },
  {
    ...
    date: '2026-09-08',
    category: 'zunou',
    thumb: '/assets/guide/zunousen-cost.webp',
  },
  {
    href: '/guide/zunousen-tournament/',
    title: '大人数の頭脳戦イベント・大会の企画方法｜対戦形式と運営の設計',
    desc: '複数卓・チーム戦・予選決勝の選び方、48名90分の仮の構成例、得点の比較方法、進行・審判・集計の体制を主催者向けに解説。',
    date: '2026-09-08',
    category: 'zunou',
    thumb: '/assets/guide/zunousen-tournament.webp',
  },
  {
    href: '/guide/shuyu-event-seisaku/',
    title: '周遊イベントの制作依頼｜費用・スケジュール・施設側の準備',
    desc: '目的の決め方、依頼前に用意する情報、制作工程と役割分担、初期制作と運営の費用、受入人数の計算を発注準備に特化して解説。',
    date: '2026-09-08',
    category: 'shisetsu',
    thumb: '/assets/guide/shuyu-event-seisaku.webp',
  },
  {
    href: '/guide/madamis-haishin/',
    title: '動画・配信用マダミスの制作依頼｜視聴者も楽しめる企画と準備',
    desc: 'ライブ配信と収録動画の設計差、出演者と視聴者に見せる情報、収録時間、シナリオ制作と映像制作の分担、配信・アーカイブの利用範囲。',
    date: '2026-09-08',
    category: 'murder',
    thumb: '/assets/guide/madamis-haishin.webp',
  },
  {
    href: '/guide/ip-event/',
    title: 'IP・キャラクターの体験型イベント制作｜企画・監修・運営の進め方',
    desc: '来場者の立場の決め方、体験化の企画例、企画・監修・制作の順番、監修範囲、利用範囲の具体化を権利元・代理店向けに解説。',
    date: '2026-09-08',
    category: 'immersive',
    thumb: '/assets/guide/ip-event.webp',
  },
  {
    href: '/guide/event-original-or-existing/',
    title: '体験型イベントはオリジナル制作か既存導入か｜費用・納期・自由度を比較',
    desc: 'オリジナル制作・既存作品の導入・部分調整の3方式を費用・納期・自由度・継続利用で比較。選び方を整理する5つの質問。',
    date: '2026-09-08',
    category: 'shisetsu',
    thumb: '/assets/guide/event-original-or-existing.webp',
  },
  {
    href: '/guide/event-revenue-share/',
    title: '施設イベントのレベニューシェアとは｜費用回収・売上分配・負担を解説',
    desc: '受託型・レベニューシェア型・併用型の違い、仮の数字による原価回収後の分配例、施設側の協力内容、契約前の確認事項。',
    date: '2026-09-08',
    category: 'shisetsu',
    thumb: '/assets/guide/event-revenue-share.webp',
  },
  {
    href: '/guide/madamis/',

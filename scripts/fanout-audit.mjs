...
const NO_COST = new Set(['madamis-tokyo','immersive-tokyo-solo','immersive-tokyo-date','tokyo-experience-date','tokyo-nazo-date','madamis-rekishi','zunousen-sakuhin','immersive-vr','botsunyukan','saiji','yougo','case-uwasabanashi','madamis-asobikata','madamis-shoshinsha']);
// 本文編集を禁止している保護ページ（一覧・特集）は監査対象から除外
const PROTECTED = new Set(['immersive-tokyo']);
const NO_TERM = new Set(['immersive-tokyo-solo','immersive-tokyo-date','tokyo-nazo-date','madamis-rekishi','zunousen-sakuhin','immersive-vr','botsunyukan','saiji','yougo','madamis-asobikata','madamis-shoshinsha']);
